...
if __name__ == "__main__":
    ...
    # exporter settings
    parser = argparse.ArgumentParser()
    parser.add_argument('--model', type=str, default='../../../onnx/iqa.onnx', help="set model checkpoint path")
    parser.add_argument('--image', type=str, default="../../../imgs/iqa_test.bmp", help='input image to use')

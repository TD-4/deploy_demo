// onnxruntime_5.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
...
int main()
{
...
#ifdef _WIN32
	const wchar_t* model_path = L"F:/GitHub/onnxruntime_6/s.onnx";
#else
	const char* model_path = "F:/GitHub/onnxruntime_6/s.onnx";
#endif
	...
	// read image
	Mat img = imread("F:\\GitHub\\onnxruntime_6\\imgs\\2\\0.bmp");
